<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="FantaMe._Default" %>
...
<script src="Scripts/sistema.js"></script>
    <div class="jumbotron" >
        ...
        DataSourceID="DsClassifica"  PageSize="8" SkinID="Gridview" 
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
            ...
            <asp:BoundField HeaderText="pti" DataField="Punteggio" 
             SortExpression="Punteggio"
             meta:resourcekey="BoundFieldResource10" >
             <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
    ...
    <asp:SqlDataSource ID="DsClassifica" runat="server" 
        ...
        SelectCommand="SELECT ROW_NUMBER() OVER (ORDER BY Punti DESC,DiffRetiTotale DESC,GoalFatti DESC,NomeSquadra DESC) as Posizione,*,'' as Spazio1 FROM CaricaGiornata(0,@anno)
ORDER BY Punti DESC,DiffRetiTotale DESC,GoalFatti DESC,NomeSquadra DESC">
        <SelectParameters>
            
            <asp:Parameter DefaultValue="2022" Name="Anno" />
        </SelectParameters>
    </asp:SqlDataSource>   
         ...
         <div class="risultatimain">
             ...
             <div class="risultati1" >
               <div class="1" data-index="0" style="padding-bottom:2px">
                            ...
                            <ul class="list-group widget-body raised-2">
                                <li data-index="0" class="list-group-item match match-result row _highlight   " data-group-id="A" data-match-index="0" data-turn-index="0" data-round="0">
                                    ...
                                    <div class="team team-home " id="3958452">
                                        ...
                                        <%--<div class="team-crest"><img class="crest" src="Calendario%20-%20Leghe%20Fantagazzetta_files/no_logo4.png" onerror="handleImageError(this, Settings.missingLogoSrc)"></div>--%>
                                    ...
                                    <div class="team team-away " id="3957902">
                                        ...
                                        <%--<div class="team-crest"><img class="crest" src="Calendario%20-%20Leghe%20Fantagazzetta_files/3957902_08162374.png" onerror="handleImageError(this, Settings.missingLogoSrc)"></div>--%>
                                ...
                                <li data-index="1" class="list-group-item match match-result row _highlight   " data-group-id="A" data-match-index="1" data-turn-index="0" data-round="0">
                                    ...
                                    <div class="team team-home " id="3957685">
                                        ...
                                        <%--<div class="team-crest"><img class="crest" src="Calendario%20-%20Leghe%20Fantagazzetta_files/no_logo13.png" onerror="handleImageError(this, Settings.missingLogoSrc)"></div>--%>
                                    ...
                                    <div class="team team-away " id="2959007">
                                        ...
                                        <%--<div class="team-crest"><img class="crest" src="Calendario%20-%20Leghe%20Fantagazzetta_files/no_logo17.png" onerror="handleImageError(this, Settings.missingLogoSrc)"></div>--%>
                                ...
                                <li data-index="2" class="list-group-item match match-result row _highlight   myself" data-group-id="A" data-match-index="2" data-turn-index="0" data-round="0">
                                    <!--<p Class="team-info">Sei al 5° POSTO in classifica nel GRUPPO B</p>-->
                                    <div class="team team-home myself" id="2959602">
                                        <%--<div class="team-shirt"><img class="shirt" src="Calendario%20-%20Leghe%20Fantagazzetta_files/2959602_07921063.png" onerror="handleImageError(this, Settings.missingShirtSrc)"></div>--%>
                                        <%--<div class="team-crest"><img class="crest" src="Calendario%20-%20Leghe%20Fantagazzetta_files/2959602_01571792.png" onerror="handleImageError(this, Settings.missingLogoSrc)"></div>--%>
                                    ...
                                    <div class="team team-away myself" id="2961556">
                                        <%--<div class="team-shirt"><img class="shirt" src="Calendario%20-%20Leghe%20Fantagazzetta_files/2961556_04822923.png" onerror="handleImageError(this, Settings.missingShirtSrc)"></div>--%>
                                        <%--<div class="team-crest"><img class="crest" src="Calendario%20-%20Leghe%20Fantagazzetta_files/no_logo11.png" onerror="handleImageError(this, Settings.missingLogoSrc)"></div>--%>
                                ...
                                <li data-index="3" class="list-group-item match match-result row _highlight   " data-group-id="A" data-match-index="3" data-turn-index="0" data-round="0">
                                    <!--<p Class="team-info">Sei al 5° POSTO in classifica nel GRUPPO B</p>-->
                                    <div class="team team-home " id="2961455">
                                        <%--<div class="team-shirt"><img class="shirt" src="Calendario%20-%20Leghe%20Fantagazzetta_files/2961455_0001171291.png" onerror="handleImageError(this, Settings.missingShirtSrc)"></div>--%>
                                    ...
                                    <div class="team team-away " id="3954154">
                                        <%--<div class="team-shirt"><img class="shirt" src="Calendario%20-%20Leghe%20Fantagazzetta_files/3954154_0847892.png" onerror="handleImageError(this, Settings.missingShirtSrc)"></div>--%>
                       ...
                       <a href = "https://leghe.fantagazzetta.com/fantamondo-serie-a/classifica" Class="btn btn-sm btn-grey pull-right">Dettaglio Giornata </a>
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
    ...
    <asp:SqlDataSource ID="DsChampions" runat="server" 
        ...
        SelectCommand="SELECT Id, ROW_NUMBER() OVER (ORDER BY PuntiCampionato DESC,NomeSquadra ASC) as Posizione,NomeSquadra,PuntiCampionato as Punti FROM PunteggioCoppeEuropee(@Giornata,@anno,'C')">
        <SelectParameters>
            <asp:Parameter DefaultValue="2022" Name="Anno" />
...
<ItemStyle HorizontalAlign="Center"></ItemStyle>
    ...
    <asp:SqlDataSource ID="DsEuropa" runat="server" 
        ...
        SelectCommand="SELECT Id, ROW_NUMBER() OVER (ORDER BY PuntiCampionato DESC,NomeSquadra ASC) as Posizione,NomeSquadra,PuntiCampionato as Punti FROM PunteggioCoppeEuropee(@Giornata,@anno,'E')">
        <SelectParameters>
            <asp:Parameter DefaultValue="2022" Name="Anno" />
            <asp:Parameter DefaultValue="0" Name="Giornata" />
